  ...
  theme: {
    extend: {
      ...
      backgroundImage:{
        ...
        CircluarDark:'repeating-radial-gradient(rgba(225,225,225,0.8) 2px,#1b1b1b 7px, #1b1b1b 100px);',
        circleLightLg:'repeating-radial-gradient(rgba(0,0,0,0.4) 2px,#f5f5f5 5px, #f5f5f5 80px);',
        circleDarkLg:'repeating-radial-gradient(rgba(225,225,225,0.8) 2px,#1b1b1b 5px, #1b1b1b 80px);',
